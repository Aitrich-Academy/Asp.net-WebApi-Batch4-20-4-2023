  ...
  public class CategoryManager
    {
        ...
        public string updateCategory(Category obj, int Id)
        {
            int result = 0;
            var objUser = db_category.Category.Where(e => e.id == Id && e.status != "D").SingleOrDefault();
            if (objUser != null)
            {
